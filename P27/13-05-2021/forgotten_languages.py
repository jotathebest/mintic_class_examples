...
# words --> max 2
words = input("insert the words: ")
# phrases --> max 3 words
modern_phrases = input("insert the modern language phrases: ")
...
words = words.split(" ")
modern_phrases = modern_phrases.split(" ")

if words[0] in modern_phrases:
    print(f"word {words[0]}: YES")
else:
    print(f"word {words[1]}: NO")

if len(words) > 1:
    if words[1] in modern_phrases:
        print(f"word {words[1]}: \"YES\"")
    else:
        print(f'word {words[1]}: "NO"')
